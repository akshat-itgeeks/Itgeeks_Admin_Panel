...
function OrderView(
    ...
    const UserData = [
        ...
        {
            img: 'https://images.unsplash.com/photo-1553456558-aff63285bdd1?q=80&w=1374&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
            name: 'Standard Drinks',
            size: '10x20',
            shape: 'circular',
            finish: 'matte',
            artWork: 'https://images.unsplash.com/photo-1553456558-aff63285bdd1?q=80&w=1374&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
            quantity: '20',
            total: '500'
            ...
            <div className=' w-full flex flex-col gap-5'>
                ...
                <div>
                    <div className=' w-full flex flex-col gap-3 items-center'>
                        ...
                        <div className=' w-full divide-y-2 flex-col justify-between bg-slate-100 rounded-md px-2 py-2'>
                            {
                                UserData?.map((itm, indx) => {
                                    return <div key={indx} className=' w-full items-center   select-none border-zinc-200 flex justify-between    rounded-md  px-1 py-3'>
                                        <div className=' w-full  gap-3 text-[14.5px] flex items-center self-center '>
                                            <img src={itm.img} className='border object-center p-[3px] shadow-md rounded w-28 h-28 object-cover' alt="" />
